...
def runAMOSA(amosaParams):
    ...
    def consoleprint(case,i):
        ...
        print(  "____________________________________________________", end='\r')
        print(  'iteration: ' + str(i) + '\t' + 'Temperature: ' + '%.10f'%t  + '\t'+ 'archivesize: ' + str(amosaParams.i_archivesize), end='\r')
